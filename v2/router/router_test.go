...
func (c *recordComponent) Mount()                  {}
func (c *recordComponent) Unmount()                {}
func (c *recordComponent) OnMount()                {}
func (c *recordComponent) OnUnmount()              {}
func (c *recordComponent) GetName() string         { return c.name }
func (c *recordComponent) GetID() string           { return c.name }
func (c *recordComponent) SetSlots(map[string]any) {}
func (c *recordComponent) IsMounted() bool         { return false }
func (c *recordComponent) OnParams(p map[string]string) {
	c.SetRouteParams(p)
}
