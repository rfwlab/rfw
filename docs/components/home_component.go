...
func NewHomeComponent() *core.HTMLComponent {
	...
	snippets := []map[string]string{
		{"title": "GO component 1", "image": "https://cdn.gxbs.dev/HeRO2/ZipiBEQe56.png/raw"},
		{"title": "Go component 2", "image": "https://cdn.gxbs.dev/HeRO2/gUsoDUxU99.png/raw"},
		{"title": "RTML", "image": "https://cdn.gxbs.dev/HeRO2/qIrawiBa17.png/raw"},
		{"title": "Browser Preview", "image": "https://cdn.gxbs.dev/HeRO2/ZimIsErA38.png/raw"},
	...
	renderSnippet := func(index int) {
		...
		html := fmt.Sprintf(`
				<div class="relative w-full p-3 pt-11 rounded-2xl shadow-2xl text-white overflow-hidden"
						style="background-image: url('https://cdn.gxbs.dev/HeRO2/haqIFIJe53.png/raw'); background-size: cover; background-position: center; min-height: 400px; min-width: 400px;">
